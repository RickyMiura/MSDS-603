from metaflow import FlowSpec, step, resources, timeout, retry, catch, conda, conda_base
...
class ClassifierTrainFlow(FlowSpec):
    ...
    def choose_model(self, inputs):
        ...
        mlflow.set_experiment('lab-7-experiment')
        ...
        with mlflow.start_run():
            mlflow.sklearn.log_model(self.model, artifact_path = 'lab-7-train', registered_model_name="lab-7-wine-model")
